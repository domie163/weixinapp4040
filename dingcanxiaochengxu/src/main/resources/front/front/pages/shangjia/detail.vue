	...
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback"
		...
		<view class="container">
			...
			<view class="name shop-title"
                  :style='{"boxShadow":"0 0 6rpx rgba(0,0,0,.3)","margin":"0 0 20rpx 0","borderColor":"#fff","backgroundColor":"#fff","color":"#6a4826","borderRadius":"0","borderWidth":"0","fontSize":"36rpx","borderStyle":"solid"}'>
				商家名称：{{detail.shangjiaName}}
            </view>
					...
					<view class="detail-list-item"
						...
						<view class="lable"
							...
							商家星级类型：</view>
						<view class="text" :style='{"color":"#6a4826","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.shangjiaXingjiValue}}</view>
					</view>
			</view>
