<template>
	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        <view class="search-form round">
				<input v-model="searchForm.goodsCommentbackText" type="text" placeholder="评价内容"></input>
		</view>
	...
	<view class="list b-b" v-for="(item, index) in list" :key="index">
        ...
        <view style="float: right;margin-right: 25upx;">
            <text v-if="isAuth('goodsCommentback','删除')" style="margin: 0 50upx 0 30rpx;" class="cuIcon-delete" @click.stop="onDeleteTap(item.id)"></text>
        </view>
