		...
		<form class="app-update-pv">
            ...
            <view
                ...
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#6a4826","textAlign":"left"}'
                          class="title">会员等级</view>
                    <picker @change="huiyuandengjiTypesChange" :value="huiyuandengjiTypesIndex" :range="huiyuandengjiTypesOptions" range-key="indexName">
                        <view
                                :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#6a4826","borderRadius":"0px","color":"#6a4826","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx"}'
                                class="uni-input">{{ruleForm.huiyuandengjiTypes?ruleForm.huiyuandengjiValue:"请选择会员等级"}}</view>
                    </picker>
                </view>
...
<script>
	...
	export default {
		data() {
			return {
				...
				ruleForm: {
					...
					newMoney: '',
					yonghuSumJifen: '',
					huiyuandengjiTypes: '',//数字
					huiyuandengjiValue: '',//数字对应的值
					yonghuDelete: '',
					createTime: '',
				},
				// 登陆用户信息
		...
		/*下拉框*/
			let huiyuandengjiTypesParams = {
				page: 1,
				limit: 100,
				dicCode: 'huiyuandengji_types',
			}
			let huiyuandengjiTypes = await this.$api.page(`dictionary`, huiyuandengjiTypesParams);
			this.huiyuandengjiTypesOptions = huiyuandengjiTypes.data.list
		...
		methods: {
			...
			async onSubmitTap() {
				...
				if ((!this.ruleForm.huiyuandengjiTypes)) {
					this.$utils.msg(`会员等级不能为空`);
					return
				}
				if (this.ruleForm.id) {
